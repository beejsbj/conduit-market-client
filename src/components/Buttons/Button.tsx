...
const Button: React.FC<ButtonProps> = ({
  ...
  const classNameValue = cn(
    ...
    'flex items-center gap-2 justify-center font-bold transition-colors focus:outline-hidden focus:ring-2 focus:ring-offset-2 whitespace-nowrap flex-shrink-0 group',
    {
