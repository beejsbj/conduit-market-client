        ...
        <div className="flex justify-between items-start">
          <div>
            <h3 className="font-semibold text-lg">
              ...
              {type === OrderEventType.PAYMENT_REQUEST && 'Payment Request'}
              {type === OrderEventType.SHIPPING_UPDATE && 'Shipping Update'}
              {type === OrderEventType.PAYMENT_RECEIPT && 'Payment Receipt'}
              {unread && (
            ...
            <p className="text-gray-600">{OrderUtils.getOrderSummary(event)}</p>
