...
const ShippingFormPropsSchema = z.object({
  ...
  onShippingCostUpdate: z.function().args(z.number()).returns(z.void())
})
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const formData = {
        ...
        special_instructions: (e.target as any)['checkout-special-instructions']
          .value
      }
      ...
      if (error instanceof z.ZodError) {
        ...
        setSubmitError(
          (error as Error).message || 'Unable to connect to payment server'
        )
      }
